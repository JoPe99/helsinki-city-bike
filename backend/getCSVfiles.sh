...
# This script loads all of the CSV files required for
# the server into the src/main/resources/ directory.
#
# NOTE:
...
# Curls the files as stations or MM_YYYY.csv. Option "-L" allows redirects, which are needed for the journey files.
